...
static const std::string g_test_module_name = g_library_prefix + "gain_processor_nvidia" + g_library_ext;
#elif defined GPU_AUDIO_AMD
static const std::string g_test_module_name = g_library_prefix + "gain_processor_amd" + g_library_ext;
#elif defined GPU_AUDIO_MAC
static const std::string g_test_module_name = g_library_prefix + "gain_processor" + g_library_ext;
#endif
