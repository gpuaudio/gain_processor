...
#ifndef GAIN_GAIN_MODULE_INFO_PROVIDER_H
#define GAIN_GAIN_MODULE_INFO_PROVIDER_H
...
class GainModuleInfoProvider : public GPUA::processor::v2::ModuleInfoProvider {
public:
    GainModuleInfoProvider();
    ~GainModuleInfoProvider() override = default;

    // Copy ctor and copy assignment op are deleted along with move assignment operator
    GainModuleInfoProvider& operator=(GainModuleInfoProvider&&) noexcept = delete;
...
#endif // GAIN_GAIN_MODULE_INFO_PROVIDER_H
